...
/**
 * Created by fangxubin on 2017/6/22.
 */
...
public class MyMediaController extends MediaController {
    ...
    public MyMediaController(Context context, VideoView videoView, Activity activity) {
        ...
        mGestureDetector = new GestureDetector(context, new MyMediaController.MyGestureListener());
    ...
    protected View makeControllerView() {
        ...
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources()
                .getIdentifier("mymediacontroller", "layout", getContext().getPackageName()), this);
